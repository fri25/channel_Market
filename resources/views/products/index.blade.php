...
<div class="container-app">
    ...
    <div class="relative py-20 md:py-32 overflow-hidden rounded-[3rem] bg-slate-900 mb-16 shadow-2xl">
        <div class="absolute inset-0 opacity-20">
            <div class="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,rgba(99,102,241,0.2),transparent_50%)]"></div>
        </div>
        
        <div class="relative z-10 text-center px-4">
            <span class="inline-block px-4 py-1.5 rounded-full bg-indigo-500/10 text-indigo-400 text-xs font-bold uppercase tracking-widest mb-6 border border-indigo-500/20">
                Catalogue Premium 2026
            </span>
            <h1 class="text-4xl md:text-7xl font-black tracking-tighter text-white mb-8 leading-tight">
                Découvrez nos <span class="text-indigo-400 italic">Produits</span> <br> Numériques d'Elite
            </h1>
            <p class="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed font-medium">
                Propulsez vos projets à la vitesse supérieure avec nos ressources premium, scripts et e-books soigneusement élaborés par des experts.
            </p>
            ...
            <div class="card-premium group flex flex-col h-full bg-white">
                ...
                <div class="relative aspect-[4/3] overflow-hidden">
                    ...
                    <div class="absolute top-4 left-4">
                        <span class="badge-premium bg-slate-900/80 text-white backdrop-blur shadow-lg">Nouveauté</span>
                    </div>
                </div>
                
                <div class="p-8 flex flex-col flex-grow">
                    <h3 class="text-xl font-bold text-slate-900 mb-3 group-hover:text-indigo-600 transition-colors duration-300 leading-tight">{{ $product->title }}</h3>
                    <p class="text-slate-500 mb-8 line-clamp-2 text-sm leading-relaxed font-medium">
                        {{ $product->description }}
                    </p>
                    
                    <div class="mt-auto pt-6 border-t border-slate-50 flex items-center justify-between">
                        <a href="{{ route('products.show', $product) }}" class="text-sm font-bold text-indigo-600 hover:text-indigo-800 flex items-center gap-2 transition-all group/link">
                            Détails du produit
