...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
    <div class="bg-white rounded-3xl p-8 sm:p-12 shadow-sm border border-gray-100 text-center relative overflow-hidden">
        ...
        <div class="absolute -bottom-10 -left-10 w-40 h-40 bg-gradient-to-tr from-indigo-100 to-purple-100 rounded-full blur-2xl opacity-50"></div>
        ...
        <div class="relative z-10">
            ...
            <a href="{{ route('download', $order->download_token) }}" target="_blank" class="inline-flex items-center justify-center w-full sm:w-auto px-8 py-4 bg-indigo-600 text-white font-bold rounded-2xl hover:bg-indigo-700 transition shadow-lg shadow-indigo-500/30 transform hover:-translate-y-1">
